  ...
  function displayLists(data) {
    try {
        ...
        Object.keys(data).forEach(status => {
            ...
            // Objeto para rastrear libros ya agregados SOLO en este list-section
            const addedBookIds = {};
            ...
            data[status].forEach(book => {
                ...
                if (status === 'favourites' && !book.favourite) {
                    return;
                }

                // Verificar si el libro ya ha sido agregado EN ESTE list-section
                if (addedBookIds[book.id]) {
                    console.log(`Libro ${book.id} ya agregado en ${status}, omitiendo duplicado`);
                    return;
                }
                ...
                // Marcar el libro como agregado SOLO en este list-section
                addedBookIds[book.id] = true;
            });
        });
    } catch (error) {
